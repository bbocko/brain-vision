    ...
    return (
        <div className="flex flex-col items-center mt-12">
            ...
            <div className="flex flex-col mt-4 sm:flex-row sm:justify-center">
                ...
                <button className="px-4 py-2 rounded-lg text-white bg-blue-500 hover:bg-blue-600 transition duration-200 active:opacity-80 w-full sm:w-auto">Detect</button>
            </div>
        </div>
    );
}
